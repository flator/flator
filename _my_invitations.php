...
else
{
	...
	$q = "SELECT * FROM fl_users WHERE id = '" . (int)$userProfile["id"] . "' LIMIT 1";
...
$i = 1;
while ( $i2 < $invitesLeft) {
$body .= "<p><label style=\"width:120px;\" for=\"inviteMail".$i."\">E-post till flata ".$i.":</label> <input type=\"text\" id=\"inviteMail".$i."\" name=\"inviteMail".$i."\" value=\"\" /></p>";
$i2++;
$i++;
}
$body .= "
...
<p style=\"margin-bottom: 40px; font-weight: bold; color: rgb(199,70,61);\">Du har inga inbjudningar kvar!</p>";
