<?php
$metaTitle = "Flator.se - Topplistor - Bloggar";
$numPerPage = 50;
...
else
{
	...
	$currentLink = array();
		...
		$q = "SELECT fl_users . *, UNIX_TIMESTAMP(fl_users.lastVisibleOnline) AS unixTime
FROM fl_users
ORDER BY fl_users.blogVisits DESC 
LIMIT 30";
...
<div id=\"divHeadSpace\" style=\"border: 0px; line-height: 10px\">&nbsp;</div><div style=\"float: left; \"><div style=\"padding-top: 6px; padding-bottom: 4px;border:none; border-bottom: 1px dotted #c8c8c8; width:592px; margin-bottom:10px;\" width=\"595px\"><h3>De 30 mest lästa bloggarna</h3></div></div>";
...
<table border=\"0\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"font-size: 12px;margin-top:0px;\">";
  ...
  $body .= "</div>
	...
	$blogPosts = $DB->CacheGetAssoc( 3600*48, $q, FALSE, TRUE );
