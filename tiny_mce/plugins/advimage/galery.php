...
$GDok = TRUE;
// ------------ config section --------------------
$IMGFOLDER = $_SERVER["DOCUMENT_ROOT"] . "/rwdx/admin";
$IMGURL = 'http://www.flator.se/rwdx/admin';
$VIDEOICON = 'video.jpg';
$AUDIOICON = 'audio.jpg';
// language setting   en
$LARGEIMG = 'F&ouml;rhandsgranska';
$DELETEIMG = 'Ta bort bild';
$INSERTIMG = 'Importera bild';
$UPLOADIMG = 'Ladda upp';
$HELPSTR = 'Markera en bild';
// -------------------------------------------------
?>
