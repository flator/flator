...
<?php echo get_the_title($post->post_parent); ?></a> &raquo; 
<a href="<?php echo get_permalink() ?>" rel="bookmark" title="Permanent Link: 
<?php the_title(); ?>"><?php the_title(); ?></a>
		...
		<?php echo $attachment_link; ?><br /><?php echo basename($post->guid); ?>
				</p>
			</div><!-- end .entry -->
