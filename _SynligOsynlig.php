...
/*# ----------------------------------------------------------------------------
 ...
 Script Function:
	           show the information page about visibility function, for users who are not registred!
 Licenced  to: Bebetteronline.com
 Date:  	   2012-02-10
# ----------------------------------------------------------------------------*/
$metaTitle = "M&ouml;tesplats och dating f&ouml;r lesbiska - Flator.se.";
$metaDescription=" Vill du bara titta utan att synas? Även om vi på Flator.se uppmanar till möten och interaktion så det inte ett måste. Bli medlem idag!";

$body = "<div id=\"center\"><div style=\"padding-top: 12px; border-top: 1px dotted #c8c8c8;padding-bottom:4px;\"><br> 
<br><br><br></div>";

$body .= "
<img src=\"".$baseUrl."/img/onsynlig.jpg\" border=\"0\" ><br><br>";

$body .= "
<div style=\"padding-top: 4px; border-top: 1px dotted #c8c8c8;padding-bottom:4px;\"><br><span style=\"font-weight:bold; font-size:16px;\">Synlig / osynlig</span><br><br>Vill du bara titta utan att synas? Även om vi på Flator.se uppmanar till möten och interaktion så det inte ett måste. Du kan själv välja om du ska vara synlig eller ej. 
Bli medlem idag!
<br><br></div>
